...
TEST_CASE("test nv3023 to draw color bar with SPI interface", "[nv3023][spi]")
{
    ...
    const spi_bus_config_t buscfg = NV3023_PANEL_BUS_SPI_CONFIG(TEST_PIN_NUM_LCD_PCLK, TEST_PIN_NUM_LCD_DATA0,
    ...
    const esp_lcd_panel_io_spi_config_t io_config = NV3023_PANEL_IO_SPI_CONFIG(TEST_PIN_NUM_LCD_CS, TEST_PIN_NUM_LCD_DC,
    ...
    TEST_ESP_OK(esp_lcd_new_panel_nv3023(io_handle, &panel_config, &panel_handle));
